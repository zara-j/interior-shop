...
const TitlePic = () => {
  return (
    <div className="relative flex items-center justify-center lg:justify-end font-notoSans text-left">
      ...
      <div className="absolute bg-rose-950 rounded shadow-lg p-5 xl:mr-16 sm:p-8 md:p-10 lg:p-12"
        ...
        <div className="container text-left">
          ...
          <button className="bg-amber-500 text-light py-4 px-6 lg:px-16 sm:py-4 mt-3 mb-0 sm:w-auto"
