        ...
        <div className="bg-light py-10">
            <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start px-5">
                <div className="lg:text-left p-5 lg:w-[40%]">
                    ...
                    <p className="text-lg font-semibold text-gray-500 my-6 lg:text-left">
                ...
                <div className="overflow-x-scroll no-scrollbar w-full lg:w-[60%]">
                    <div className="flex space-x-6">
                        {images.map((img, index) => (
                            <img
                                ...
                                className="min-w-[400px] lg:min-w-[600px] h-[450px] object-cover shadow-lg"
                            />
                        ))}
                    </div>
                </div>
